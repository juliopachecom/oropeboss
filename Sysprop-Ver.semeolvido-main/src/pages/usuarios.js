...
const editarCliente = async (ruta, id, nombre, cedula, fechaNacimiento, correo, username, password, cargo) => {
  ...
  // const clientes = await axios.get(ruta);
  // const clienteExistente = clientes.data.filter(
  //   (clientes) => clientes.cedula === cedula
  // );
  // if (clienteExistente.length > 0) {
  //   alert("Esta cedula ya se encuentra registrada.");
  //   return;
